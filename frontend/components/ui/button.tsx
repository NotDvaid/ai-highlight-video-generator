...
const buttonVariants = cva(
  ...
  'bg-primary text-primary-foreground hover:bg-primary/90 hover:text-primary-foreground',
        ...
        outline:
          'border bg-background shadow-xs transition-all ' +
          'hover:bg-secondary/80 hover:text-secondary-foreground hover:border-primary ' +
          'dark:hover:bg-secondary/80 dark:hover:text-secondary-foreground ' +
